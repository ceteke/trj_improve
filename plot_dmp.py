...
#exit()
tl1 = TrajectoryLearning('/home/alive/Desktop/torque_demos/close3', 13, 100, 1, 5, True, init_std=1, torque_goal=True)
...
# np.savetxt('/home/alive/Desktop/ee.csv', np.concatenate((t.reshape(-1, 1), x), axis=1) ,delimiter=',')
# exit()
...
#
# x = np.loadtxt('/media/alive/Feyyaz/MSc/lfd_improve_demos/close/ex1/5/2/x.csv', delimiter=',')
# t = x[:, 0]
# x = x[:, 1:]
#
# for i in coords:
#     axs[i-min_coords].plot(t, x[:,i], color='red', lw=1)
